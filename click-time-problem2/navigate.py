...
def GetOptions(origin,destination,mode):
    ...
    for i,r in enumerate(results):
        ...
        if mode=='t':
            ...
            time_taken=g.Summary(origin,new_destination,'time',mode)
            if bike_or_walk in YES_OPTIONS :
                time_taken=time_taken+g.Summary(new_destination,destination,'time','b')
            else :
                time_taken=time_taken+g.Summary(new_destination,destination,'time','w')
        else:
